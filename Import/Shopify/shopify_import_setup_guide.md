...
<img width="1280" height="562" alt="Screenshot 2026-01-22 at 3 56 25 PM" src="https://github.com/user-attachments/assets/68269168-2b2c-4874-b392-744da825985a" />
...
#### Kindly take note: 
##### Please Key in URL without https:// (Example : testing.myshopify.com)

<img width="1728" height="1020" alt="image" src="https://github.com/user-attachments/assets/2690e6e1-c421-4cb8-b339-4900e86581d3" />
...
#### **Step 4:** You will then be redirected to your Shopify admin page, and click on the "Update" button

<img width="1280" height="659" alt="image" src="https://github.com/user-attachments/assets/9670e410-9246-4ef1-ad4a-64cca34d7c11" />

---

#### **Step 5:** Under "EasyConnect", click on "Installed Ecommerce Apps", find "Shopify Import" and click on "Open App" button

<img width="1280" height="644" alt="image" src="https://github.com/user-attachments/assets/644e759d-cf35-47a7-81fc-76134350bc5e" />

---

#### **Step 6:** Find your connected store on the store page, and click into the store
...
#### **Step 8:** Click on "Order", select the order date and order status and click on the "Search" button. The order will be imported and shown in the list below.
...
**You may proceed to checkout our [Shopify Import Fulfilment Steps](https://github.com/easyparcel/nextgen-integration-doc/blob/beb80c10947afc5c7e01e4e03ee40557ddca4602/Import/Shopify/shopify_import_fulfilment.md)**
